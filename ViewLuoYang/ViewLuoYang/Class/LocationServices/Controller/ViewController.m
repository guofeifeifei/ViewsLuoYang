...
@interface ViewController ()<MAMapViewDelegate, AMapSearchDelegate, UITableViewDataSource, UITableViewDelegate, UIGestureRecognizerDelegate, AnnotationValeDelegate>
{
    MAMapView *_mapView;
...
- (void)initControls
{
    ...
    _locationButton.frame = CGRectMake(kDefaultControlMargin, CGRectGetHeight(_mapView.bounds) - 120, 40, 40);
    ...
    searchButton.frame = CGRectMake(80, CGRectGetHeight(_mapView.bounds) - 120, 40, 40);
    ...
    [searchButton setImage:[UIImage imageNamed:@"search"] forState:UIControlStateNormal];
      [searchButton setTitle:@"附近" forState:UIControlStateNormal];
    ...
    pathButton.frame = CGRectMake(140, CGRectGetHeight(_mapView.bounds) - 120, 40, 40);
    ...
    [pathButton setImage:[UIImage imageNamed:@"path"] forState:UIControlStateNormal];
     [searchButton setTitle:@"天气" forState:UIControlStateNormal];
